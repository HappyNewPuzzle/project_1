...
```text
> /help
< [notice] Commands: /help, /commands, /name <nickname>, /rename <nickname>, /whoami, /session, /login <playerId>, /logout, /pos, /map, /warp <mapId> <x> <y>, /move <x> <y>, /nearby, /spawn, /despawn, /users, /rooms, /room-users, /stats, /motd, /version, /join <room>, /leave, /where, /ping, /echo <message>, /time, /uptime, /me <action>, /whisper <nickname> <message>, /quit
```
